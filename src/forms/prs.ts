...
export function merge_person1(pz_s, pz_o, person_s, person_o, obj) {
  log.debug(`merge_person1: person_s '${person_s}', person_o '${person_o}', pz_s '${pz_s}', pz_o '${pz_o}'`);
  ...
  if (pz_s && pz_o) {
    ...
    } else if (obj == "INDIRECT" && person_o.endsWith("3") && person_s.endsWith("1")) {
      return pz_s + pz_o;
...
export function merge_person2(pz_s, pz_o, person_s, person_o) {
  log.debug(`merge_person2: person_s '${person_s}', person_o '${person_o}', pz_s '${pz_s}', pz_o '${pz_o}'`);
